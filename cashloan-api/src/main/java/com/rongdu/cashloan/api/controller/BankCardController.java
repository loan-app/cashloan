...
import com.rongdu.cashloan.cl.model.BankCardModel;
...
import com.rongdu.cashloan.cl.model.pay.lianlian.AgreementList;
...
import com.rongdu.cashloan.cl.service.FourElementsLogService;
...
public class BankCardController extends BaseController {
	...
	private String check(String phone,String type){
		 String message = null;
		 if(com.rongdu.cashloan.core.common.util.StringUtil
			 .isBlank(phone) || com.rongdu.cashloan.core.common.util.StringUtil.isBlank(type)){
			 message = "参数不能为空";
		 } else if(!com.rongdu.cashloan.core.common.util.StringUtil.isPhone(phone)){
			 message = "手机号码格式有误";
		 } else {
			 if(com.rongdu.cashloan.core.common.util.StringUtil.equals("register", type)){
				 // 当日最大注册用户数
				 long todayCount = cloanUserService.todayCount();
				 String dayRegisterMax_ = Global.getValue("day_register_max");
				 if(com.rongdu.cashloan.core.common.util.StringUtil.isNotBlank(dayRegisterMax_)){
			 ...
			 if (com.rongdu.cashloan.core.common.util.StringUtil.equals("findReg", type)) {
