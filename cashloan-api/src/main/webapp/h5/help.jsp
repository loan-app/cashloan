					...
					<div class="content">
						<div class=" padding info em__9">
							<ol class=" list-paddingleft-2" style="list-style-type: decimal;color:red;font-size:16px;">
								<li><p>客服电话:<span class='phone'> </span></p></li>
							</ol>
						</div>
						...
						<div class="_hidden padding info em__9">
							<p>用户注册后鲁班.柒号初始额度默认为1500元，需要通过所有认证才能激活鲁班.柒号并申请借款。具体可借额度由您提供的信息，在审核之后确定。</p>
						</div>
						<h3 class="em_1 _cursor">
							<span class="_inline_block _wraper"><img
								class="_hidden v_center"
						...
						<div class="_hidden padding info em__9">
							<p>借款手续费会在借款的时候扣除。比如您申请一笔1500元的借款，手续费为375元，实际到账为1125元。</p>
						</div>
						<h3 class="em_1 _cursor">
							<span class="_inline_block _wraper"><img
								class="_hidden v_center"
						...
						<div class="_hidden padding info em__9">
							<p>用户注册鲁班.柒号之后，会默认获得1500元的借款额度。用户需要做一些认证才能激活额度，具体认证事项如下：个人信息、紧急联系人、手机运营商、收款银行卡绑定必要4步认证，也可以补充工作信息认证、更多信息增加审批通过率。做完这些信息认证之后即可申请借款。</p>
						</div>
						<h3 class="em_1 _cursor">
							<span class="_inline_block _wraper"><img
								class="_hidden v_center"
						...
						<div class="_hidden padding info em__9">
							<p>暂时还不支持用户自行更改注册手机号，请联系客服更换。客服电话为：<span class='phone'> </span>（工作日9:00-18:00）。</p>
						</div>
						<h3 class="em_1 _cursor">
							<span class="_inline_block _wraper"><img
								class="_hidden v_center"
						...
						<div class="_hidden padding info em__9">
							<p>平台会对逾期的一笔还款收取滞纳金。比如，滞纳金一天是5%，您借款200元，则逾期1天会收取10元滞纳金；若借款500元，则收取滞纳金25元/天；1500元滞纳金为75元/天。</p>
						</div>
						<h3 class="em_1 _cursor">
							<span class="_inline_block _wraper"><img
								class="_hidden v_center"
