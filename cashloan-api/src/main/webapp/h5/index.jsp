  ...
  <div class="proView">
      <div class="proTop">
        ...
        <div class="nobtnRight">
          <img src="/static/images/nobtnRight.png" alt="" />
        </div>
      </div>
      <div class="proBtm">
        <div class="txtTop">
          ...
          <p>
            为用户打造一个极速金融借贷平台，用户可以在这里快速申请贷款，放款快捷，为用户轻松解决资金问题。
          </p>
        </div>
        <div class="txtBtm">
          ...
          <ul>
            <li class="clearfix">
              <img src="/static/images/ico001.png" alt="" />
              <div class="txtBtmTxt">
                <h3>一分钟认证</h3>
                <p>刷脸即可认证借钱，简单快捷</p>
              </div>
            ...
            <li class="clearfix">
              <img src="/static/images/ico002.png" alt="" />
              <div class="txtBtmTxt">
                <h3>10分钟放款</h3>
            ...
            <li class="clearfix">
              <img src="/static/images/ico003.png" alt="" />
              <div class="txtBtmTxt">
                <h3>无需任何抵押</h3>
                <p>纯信用贷款，无需任何抵押</p>
              </div>
            ...
            <li class="clearfix">
              <img src="/static/images/ico004.png" alt="" />
              <div class="txtBtmTxt">
                <h3>随时随地借款</h3>
            ...
            <li class="clearfix">
              <img src="/static/images/ico006.png" alt="" />
              <div class="txtBtmTxt">
                <h3>还款方式多样</h3>
            ...
            <li class="clearfix">
              <img src="/static/images/ico007.png" alt="" />
              <div class="txtBtmTxt">
                <h3>信用优质好处多</h3>
                <p>信用评级越高，审核越快</p>
              </div>
