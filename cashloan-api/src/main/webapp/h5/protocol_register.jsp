...
<div class="reg-agreement">
  <div class="reg-wrap">
    <h1>用户注册协议</h1>
    <p>郑重提示，本文系您与“鲁班.柒号演示”（以下简称平台）之间的法律协议，请您认 真阅读并理解本协议。您通过平台点击确认本协议的，即表示您同意遵循本协议的所有约定，本协议在您和平台之间具有法律约束力。如发生法律纠纷，您不得以未仔细阅读或理解本协议为由进行抗辩。
    </p>
    <h2>第一条  用户确认及服务接纳</h2>
    <p>1.1 注册用户需满足下列条件：</p>
    ...
    <h2>第五条  征信授权</h2>
    <p>5.1 用户允许业务平台委托第三方采集机构来进行相应的数据采集。</p>
    <p>5.2 用户在此不可撤销地授权平台通过依法设立的征信机构了解、咨询、审查用户的个人信息、信用状况、履约能力及其他评定用户资信状况的信息，包含可能存在的用户不良信用信息。</p>
    <p>5.3 用户在此不可撤销地授权平台向依法设立的征信机构提供用户接受平台服务所对应的个人信息、借贷信息及后续还款记录等信息。</p>
    <p>5.4 用户在此不可撤销地授权平台向依法设立的征信机构提供用户可能产生的不良信用信息。</p>
    <h2>第六条  关于电子合同</h2>
