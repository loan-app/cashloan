					...
					<div class="content">
						...
						<h3 class="em_1 _cursor">
							<span class="_inline_block _wraper"><img
								...
								width="60%" /></span> <span class="_333 v_center"> 什么是融钱贷？</span>
						</h3>
						<div class="_hidden padding info em__9">
							<p>融钱贷是一款简单便捷的无抵押纯信用借款产品，借款用户只需进行线上简单认证即可申请借款，认证一般3分钟即可完成。申请通过后，最快10分钟到账，操作简单，服务费用低。</p>
						</div>
						<h3 class="em_1 _cursor">
							<span class="_inline_block _wraper"><img
								class="_hidden v_center"
						...
						<div class="_hidden padding info em__9">
							<p>用户注册后融钱贷初始额度默认为1000元，需要通过所有认证才能激活融钱贷并申请借款。具体可借额度由您提供的信息，在审核之后确定。</p>
						</div>
						<h3 class="em_1 _cursor">
							<span class="_inline_block _wraper"><img
								class="_hidden v_center"
						...
						<div class="_hidden padding info em__9">
							<p>借款手续费会在借款的时候扣除。比如您申请一笔1000元的借款，手续费为150元，实际到账为850元。</p>
						</div>
						<h3 class="em_1 _cursor">
							<span class="_inline_block _wraper"><img
								class="_hidden v_center"
						...
						<div class="_hidden padding info em__9">
							<p>年龄：18-35周岁；拥有稳定的收入来源；无不良的信用记录。</p>
						</div>
						<h3 class="em_1 _cursor">
							<span class="_inline_block _wraper"><img
								class="_hidden v_center"
						...
						<div class="_hidden padding info em__9">
							<p>用本人实名认证的手机号注册融钱贷-&gt;完成必要7步认证-&gt;申请借款额度与期限-&gt;等待审核-&gt;等待打款-&gt;收到打款。</p>
						</div>
						<h3 class="em_1 _cursor">
							<span class="_inline_block _wraper"><img
								class="_hidden v_center"
						...
						<div class="_hidden padding info em__9">
							<p>用户注册融钱贷之后，会默认获得1000元的借款额度。用户需要做一些认证才能激活额度，具体认证事项如下：个人信息认证、工作信息认证、紧急联系人、手机运营商认证、收款银行卡绑定、授权芝麻信用、补充更多信息。做完这些信息认证之后即可申请借款。</p>
						</div>
						<h3 class="em_1 _cursor">
							<span class="_inline_block _wraper"><img
								class="_hidden v_center"
						...
						<div class="_hidden padding info em__9">
							<p>由于您没有授权融钱贷读取联系人的权限。①ios用户，可以通过设置-&gt;隐私-&gt;通讯录-&gt;融钱贷开启权限；②安卓用户，具体设置方式根据机型不同而不同。可以到设置里面开启读取权限。</p>
						</div>
						<h3 class="em_1 _cursor">
							<span class="_inline_block _wraper"><img
								class="_hidden v_center"
						...
						<div class="_hidden padding info em__9">
							<p>暂时还不支持用户自行更改注册手机号，请联系客服更换。客服电话为：0580-6876791（工作日9:00-18:00）。</p>
						</div>
						<h3 class="em_1 _cursor">
							<span class="_inline_block _wraper"><img
								class="_hidden v_center"
								...
								width="100%" /><img class="v_center"
								src="/static/images/right.png"
								width="60%" /></span> <span class="_333 v_center">如何更换银行卡？</span>
						</h3>
						<div class="_hidden padding info em__9">
							<p>账户借款还清后，前往首页-&gt;认证中心或者我的-&gt;收款银行卡，重新绑定银行卡。</p>
						</div>
						<h3 class="em_1 _cursor">
							<span class="_inline_block _wraper"><img
								class="_hidden v_center"
						...
						<div class="_hidden padding info em__9">
							<p>融钱贷产品目前要求用户必须有芝麻信用且授权融钱贷读取您的芝麻信用分数。否则无法完成借款。</p>
						</div>
						<h3 class="em_1 _cursor">
							<span class="_inline_block _wraper"><img
								class="_hidden v_center"
						...
						<div class="_hidden padding info em__9">
							<p>当天提交的审核保证当天处理，下午18点后提交的审核需要延顺到第二天工作时间处理。审核速度和当天的单量挂钩，还请各位耐心等待。</p>
						</div>
						<h3 class="em_1 _cursor">
							<span class="_inline_block _wraper"><img
								class="_hidden v_center"
						...
						<div class="_hidden padding info em__9">
							<p>①输入信息有误，这种一般被视为假数据所以被拒绝可能性很大；②
								认证不全面，比如没有芝麻授信之类，或者有些用户会先授信再取消授信，这种也会失败；③ 信用记录不好的用户一般也会被拒绝。</p>
						</div>
						<h3 class="em_1 _cursor">
							<span class="_inline_block _wraper"><img
								class="_hidden v_center"
						...
						<h3 class="em_1 _cursor">
							<span class="_inline_block _wraper"><img
								...
								width="100%" /><img class="v_center"
								src="/static/images/right.png"
								width="60%" /></span> <span class="_333 v_center">我的借款金额会被发放到哪里去？</span>
						</h3>
						<div class="_hidden padding info em__9">
							<p>一般默认借款金额会被发放到您所绑定的收款银行卡。</p>
						</div>
						<h3 class="em_1 _cursor">
							<span class="_inline_block _wraper"><img
								class="_hidden v_center"
						...
						<div class="_hidden padding info em__9">
							<p>工商银行、农业银行、光大银行、邮政储蓄银行、兴业银行、建设银行、招商银行、中国银行、浦发银行、平安银行、华夏银行、中信银行、交通银行、民生银行、广发银行。后续还会支持更多银行。</p>
						</div>
						<h3 class="em_1 _cursor">
							<span class="_inline_block _wraper"><img
								class="_hidden v_center"
						...
						<div class="_hidden padding info em__9">
							<p>① 【推荐-银行卡转账还款】，用户可打开融钱贷，进入还款点击银行卡转账，将还款金额转至银行账户中并备注好您的手机和手机号码； ②
								【支付宝还款】，用户可打开融钱贷，进入还款点击支付宝转账，将还款金额转至支付宝账户中并备注好您的手机和手机号码；
						...
						<div class="_hidden padding info em__9">
							<p>平台会对逾期的一笔还款收取滞纳金。比如，滞纳金一天是2%，您借款200元，则逾期1天会收取4元滞纳金；若借款500元，则收取滞纳金10元/天；1000元滞纳金为20元/天。</p>
						</div>
						<h3 class="em_1 _cursor">
							<span class="_inline_block _wraper"><img
								class="_hidden v_center"
						...
						<div class="_hidden padding info em__9">
							<p>不还款将会被记录个人征信，将会影响到您日后的购房贷款、购车贷款、甚至一切需要信用评分的服务申请。</p>
						</div>
					</div>
				</div>
