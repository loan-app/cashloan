...
public class Feature15dBean {
    /**
     * jiedai_avg_defaultdays_d15 : string
     * jiedai_min_defaultdays_d15 : string
     * jiedai4_sum_fail_cnt_d15 : string
     * dd_jiedai_avg_fail_days1_d15 : string
     * jiedai4_count_fill_d3_cnt_d15 : string
     * jiedai4_count_fill_d5_cnt_d15 : string
     * dd_jiedai_count_fail_mamberadd_d15 : string
     * jiedai_sum_fail_amt_d15 : string
     * dd_jiedai_max_fail_days1_d15 : string
     * sum_sure_due_days_all_pro_all_time_d15 : string
     * last_to_end_sure_due_all_pro_all_time_d15 : string
     * max_sure_due_days_non_cdq_all_time_d15 : string
     * last_to_end_sure_due_non_cdq_all_time_d15 : string
     */

    @JsonProperty("jiedai_avg_defaultdays_d15")
    private String jiedaiAvgDefaultdaysD15;
    @JsonProperty("jiedai_min_defaultdays_d15")
    private String jiedaiMinDefaultdaysD15;
    @JsonProperty("jiedai4_sum_fail_cnt_d15")
    private String jiedai4SumFailCntD15;
    @JsonProperty("dd_jiedai_avg_fail_days1_d15")
    private String ddJiedaiAvgFailDays1D15;
    @JsonProperty("jiedai4_count_fill_d3_cnt_d15")
    private String jiedai4CountFillD3CntD15;
    @JsonProperty("jiedai4_count_fill_d5_cnt_d15")
    private String jiedai4CountFillD5CntD15;
    @JsonProperty("dd_jiedai_count_fail_mamberadd_d15")
    private String ddJiedaiCountFailMamberaddD15;
    @JsonProperty("jiedai_sum_fail_amt_d15")
    private String jiedaiSumFailAmtD15;
    @JsonProperty("dd_jiedai_max_fail_days1_d15")
    private String ddJiedaiMaxFailDays1D15;
    @JsonProperty("sum_sure_due_days_all_pro_all_time_d15")
    private String sumSureDueDaysAllProAllTimeD15;
    @JsonProperty("last_to_end_sure_due_all_pro_all_time_d15")
    private String lastToEndSureDueAllProAllTimeD15;
    @JsonProperty("max_sure_due_days_non_cdq_all_time_d15")
    private String maxSureDueDaysNonCdqAllTimeD15;
    @JsonProperty("last_to_end_sure_due_non_cdq_all_time_d15")
