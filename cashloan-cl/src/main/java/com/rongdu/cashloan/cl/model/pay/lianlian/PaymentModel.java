...
import com.rongdu.cashloan.cl.model.pay.lianlian.util.PaySecurity;
 ...
 * @author gc
 * @version 1.0.0
 * @date 2017年3月6日 上午11:27:28 Copyright 杭州融都科技股份有限公司 All Rights Reserved
...
public class PaymentModel extends BasePaymentModel {
	...
	public void sign() {
		...
		String encryptStr = PaySecurity.encrypt(JSON.toJSONString(pubMap),
				Global.getValue(LianLianConstant.PUBLIC_KEY));
