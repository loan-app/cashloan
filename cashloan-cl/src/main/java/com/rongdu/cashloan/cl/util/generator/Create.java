package com.rongdu.cashloan.cl.util.generator;
...
public class Create {
	...
	public void test(){
		...
		//类名前缀
		String classNamePrefix = "operatorReport";
