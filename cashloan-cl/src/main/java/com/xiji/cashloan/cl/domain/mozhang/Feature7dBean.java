...
public class Feature7dBean {
    /**
     * jiedai4_sum_fail_cnt_d7 : string
     * jiedai_avg_defaultdays_d7 : string
     * jiedai4_count_fill_d3_cnt_d7 : string
     * jiedai_max_defaultdays_d7 : string
     * dd_jiedai_sum_fill_d5_cnt_d7 : string
     * dd_jiedai_count_fail_mamberadd_d7 : string
     * dd_jiedai_avg_fail_days1_d7 : string
     * jiedai_min_defaultdays_d7 : string
     * last_to_end_sure_due_all_pro_all_time_d7 : string
     * max_sure_due_days_non_cdq_all_time_d7 : string
     * sum_sure_due_days_all_pro_all_time_d7 : string
     * last_to_end_sure_due_non_cdq_all_time_d7 : string
     */

    @JsonProperty("jiedai4_sum_fail_cnt_d7")
    private String jiedai4SumFailCntD7;
    @JsonProperty("jiedai_avg_defaultdays_d7")
    private String jiedaiAvgDefaultdaysD7;
    @JsonProperty("jiedai4_count_fill_d3_cnt_d7")
    private String jiedai4CountFillD3CntD7;
    @JsonProperty("jiedai_max_defaultdays_d7")
    private String jiedaiMaxDefaultdaysD7;
    @JsonProperty("dd_jiedai_sum_fill_d5_cnt_d7")
    private String ddJiedaiSumFillD5CntD7;
    @JsonProperty("dd_jiedai_count_fail_mamberadd_d7")
    private String ddJiedaiCountFailMamberaddD7;
    @JsonProperty("dd_jiedai_avg_fail_days1_d7")
    private String ddJiedaiAvgFailDays1D7;
    @JsonProperty("jiedai_min_defaultdays_d7")
    private String jiedaiMinDefaultdaysD7;
    @JsonProperty("last_to_end_sure_due_all_pro_all_time_d7")
    private String lastToEndSureDueAllProAllTimeD7;
    @JsonProperty("max_sure_due_days_non_cdq_all_time_d7")
    private String maxSureDueDaysNonCdqAllTimeD7;
    @JsonProperty("sum_sure_due_days_all_pro_all_time_d7")
    private String sumSureDueDaysAllProAllTimeD7;
    @JsonProperty("last_to_end_sure_due_non_cdq_all_time_d7")
