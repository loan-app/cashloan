 ...
 */
public class MerchantUserQueryResVo {
    ...
    public String getRt7_userStatus() {
        return rt7_userStatus;
    }

    public void setRt7_userStatus(String rt7_userStatus) {
        this.rt7_userStatus = rt7_userStatus;
