...
public class MerchantUserQueryVo {
    ...
    private String P6_legalPersonID;
    ...
    public String getP6_legalPersonID() {
        return P6_legalPersonID;
    }

    public void setP6_legalPersonID(String p6_legalPersonID) {
        P6_legalPersonID = p6_legalPersonID;
    }
}
