...
public class ConventPFX {
    ...
    public static final String PFX_KEYSTORE_FILE = "d:\\81231006211009090.pfx";//pfx文件位置
    public static final String KEYSTORE_PASSWORD = "vpos123";//导出为pfx文件的设的密码
    public static final String JKS_KEYSTORE_FILE = "d:\\81231006211009090.jks"; //jks文件位置
