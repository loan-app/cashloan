 ...
 * @describe :渠道数据统计
 */
public class ChannelStatisticModel implements Serializable {
     ...
     * 老客申请数
     */
    private Integer oldBorrowApplyCount;

    /**
     * 老客机审通过数
     */
    private Integer oldMachineAuditPassCount;

    /**
     * 老客机审拒绝数
     */
    private Integer oldMachineAuditNotPassCount;

    /**
     * 老客人工通过数
     */
    private Integer oldReviewPassCount;

    /**
     * 老客人工拒绝数
     */
    private Integer oldReviewNotPassCount;

    /**
     * 新客人工复审通过率
     */
    private Double newReviewPassRate;

    /**
     * 新客人工复审拒绝率
     */
    private Double newReviewNotPassRate;

    /**
     * 老客人工复审通过率
     */
    private Double oldReviewPassRate;
    ...
    public Integer getOldBorrowApplyCount() {
        return oldBorrowApplyCount;
    }

    public void setOldBorrowApplyCount(Integer oldBorrowApplyCount) {
        this.oldBorrowApplyCount = oldBorrowApplyCount;
    }

    public Integer getOldMachineAuditPassCount() {
        return oldMachineAuditPassCount;
    }

    public void setOldMachineAuditPassCount(Integer oldMachineAuditPassCount) {
        this.oldMachineAuditPassCount = oldMachineAuditPassCount;
    }

    public Integer getOldMachineAuditNotPassCount() {
        return oldMachineAuditNotPassCount;
    }

    public void setOldMachineAuditNotPassCount(Integer oldMachineAuditNotPassCount) {
        this.oldMachineAuditNotPassCount = oldMachineAuditNotPassCount;
    }

    public Integer getOldReviewPassCount() {
        return oldReviewPassCount;
    }

    public void setOldReviewPassCount(Integer oldReviewPassCount) {
        this.oldReviewPassCount = oldReviewPassCount;
    }

    public Integer getOldReviewNotPassCount() {
        return oldReviewNotPassCount;
    }

    public void setOldReviewNotPassCount(Integer oldReviewNotPassCount) {
        this.oldReviewNotPassCount = oldReviewNotPassCount;
    }

    public Double getNewReviewPassRate() {
        return newReviewPassRate;
    }

    public void setNewReviewPassRate(Double newReviewPassRate) {
        this.newReviewPassRate = newReviewPassRate;
    }

    public Double getNewReviewNotPassRate() {
        return newReviewNotPassRate;
    }

    public void setNewReviewNotPassRate(Double newReviewNotPassRate) {
        this.newReviewNotPassRate = newReviewNotPassRate;
    }

    public Double getOldReviewPassRate() {
        return oldReviewPassRate;
    }

    public void setOldReviewPassRate(Double oldReviewPassRate) {
        this.oldReviewPassRate = oldReviewPassRate;
    }

    public Double getOldReviewNotPassRate() {
        return oldReviewNotPassRate;
    }
