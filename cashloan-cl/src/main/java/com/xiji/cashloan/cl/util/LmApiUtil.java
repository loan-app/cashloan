...
public class LmApiUtil {
    ...
    public static void subBlack(List<Black> blackList) {
        ...
        JSONObject ret = ApiClientUtil.submit("subBlack", json);
    ...
    public static boolean userDetail(String idcard, String phone, String name) {
        try {
            ...
            json.put("name", name);
            JSONObject ret = ApiClientUtil.submit("userDetail", json);
            log.info("userDetail:"+ret.toString());
            if(ret.getJSONObject("body") != null
                    && ret.getJSONObject("body").getJSONObject("detail") != null) {
                int flag = ret.getJSONObject("body").getJSONObject("detail").getIntValue("flag");
                log.info("flag:"+flag);
                if(flag == 2) {
                    return true;
                }
            ...
            log.error("绿盟黑名单请求出错:" + e.toString());
        }
        return false;
    }
    ...
    public static class ApiClientUtil {
