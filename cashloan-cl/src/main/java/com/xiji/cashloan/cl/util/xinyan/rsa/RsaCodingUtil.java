package com.xiji.cashloan.cl.util.xinyan.rsa;

import com.xiji.cashloan.cl.util.xinyan.FormatUtil;
...
public final class RsaCodingUtil {
	 ...
	 * @return
	 */
	public static String decryptByPriPfxFile(String src, InputStream pfxStream, String priKeyPass) {
		if (pfxStream == null) {
			return null;
		}
		PrivateKey privateKey = RsaReadUtil.getPrivateKeyFromFile(pfxStream, priKeyPass);
		if (privateKey == null) {
			return null;
		}
	 ...
	 * @return
	 */
	public static String encryptByPriPfxFile(String src, InputStream pfxStream, String priKeyPass) {
		if(pfxStream == null) {
			return null;
		}
		PrivateKey privateKey = RsaReadUtil.getPrivateKeyFromFile(pfxStream, priKeyPass);
