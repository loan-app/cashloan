package com.xiji.cashloan.core.common.web.controller;
...
import com.xiji.cashloan.core.common.exception.ParamValideException;
...
import com.xiji.cashloan.core.common.util.ValidateCode;
import com.xiji.cashloan.system.domain.SysUser;
import com.xiji.cashloan.system.security.authentication.handler.SaveLoginInfoAuthenticationSuccessHandler;
...
import com.xiji.cashloan.system.security.userdetails.UserFunction;
import com.xiji.cashloan.system.security.userdetails.UserRole;
	...
	public Map<String, Object> getRequestFormMap(HttpServletRequest request) throws UnsupportedEncodingException{
		...
		if(StringUtil.isNotBlank(str) && params.size()==0){
			...
			for (int i = 0; i < strs1.length; i++) {
				String[] temp = StringUtils.split(strs1[i], "=", 2);
