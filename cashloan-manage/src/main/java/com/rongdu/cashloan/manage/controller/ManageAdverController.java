...
import com.rongdu.cashloan.cl.domain.Adver;
import com.rongdu.cashloan.cl.service.AdverService;
...
import com.rongdu.cashloan.core.common.util.file.FileUtil;
import com.rongdu.cashloan.core.common.util.file.UploadFileModel;
...
@Controller
@Scope("prototype")
public class ManageAdverController extends ManageBaseController {
	...
	public void save(@RequestParam(value = "title", required = true) String title,
		...
		UploadFileModel model = FileUtil.uploadImg(file, "", "banner");
		int count = 0;
