    ...
    handleOk(e) {
      ...
      getFieldProps,getFieldValue
        ...
        this.props.form.validateFields((errors, values) => {
            ...
            let j;
            getFieldValue('keys').forEach(item => {
                let a = item;
                ...
                ruleConfig.push(<Row key={j + '' + i}>
                    ...
                    <Col span="13">
                        <FormItem  {...formItemLayout} label="执行优先级:">
                            <Input type="number" style={{width: 100}} disabled={!props.canEdit}   {...getFieldProps(`${j}${i}configSort`, { onChange: this.changeInt, getValueFromEvent: this.changeNUm, initialValue: sort[0] ? Number(sort[i]) : 0, rules: [{ type: 'number', max: 2147483647, message: '输入过多' }] }) } />
                        </FormItem>
                    </Col>
                ...
                <Row>
                    ...
                    <Col span="11" className='col_h'>
                        <FormItem  {...{
                            ...
                            <Input type="number" style={{width: 100}} disabled={!props.canEdit}    {...getFieldProps(`${k}ruleSort`, { onChange: this.changeInt, getValueFromEvent: this.changeNUm, initialValue: this.formData && this.formData[`${k}ruleSort`] ? Number(this.formData[`${k}ruleSort`]) : 0 , rules: [{type: 'number', max: 2147483647, message: '输入过多' }] }) } />
                        </FormItem>
                    </Col>
