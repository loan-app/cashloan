                ...
                ruleConfig.push(<Row key={k+''+i}>
                    ...
                    <Col span="13">
                        <FormItem  {...formItemLayout} label="执行优先级:">
                            <Input type="number" style={{width: 100}} {...getFieldProps(`${k}${i}configSort`, { onChange: this.changeInt, getValueFromEvent: this.changeNUm, initialValue: 0, rules: [{type: 'number', max: 2147483647, message: '输入过多' }] }) } />
                        </FormItem>
                    </Col>
                ...
                <Row>
                    ...
                    <Col span="11" className='col_h'>
                        <FormItem  {...{
                            ...
                            <Input type="number" style={{width: 100}} {...getFieldProps(`${k}ruleSort`, { onChange: this.changeInt, getValueFromEvent: this.changeNUm, initialValue: 0, rules: [{type: 'number', max: 2147483647, message: '输入过多' }] }) } />
                        </FormItem>
                    </Col>
                    <Col span="2">
