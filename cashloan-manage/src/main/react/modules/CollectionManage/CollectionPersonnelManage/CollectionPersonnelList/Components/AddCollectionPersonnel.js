...
var AddCollectionPersonnel = React.createClass({
  getInitialState() {
    return {
      status: {},
      formData: {}
  ...
  handleOk(e) {
    ...
    var url = "/modules/manage/system/user/saveCollection.htm";
            ...
            <Row>
              ...
              <Col span="12">
                <FormItem  {...formItemLayout} label="真实姓名:">
                  <Input disabled={!props.canEdit}  {...getFieldProps('name', { rules: [{required:true,message:'必填,且不超过二十位',max: 20}]})} type="text" autoComplete="off" />
                </FormItem> 
               </Col>
            </Row>
            <Row>
...
AddCollectionPersonnel = createForm()(AddCollectionPersonnel);
export default AddCollectionPersonnel;