    ...
    var columns = [{
      ...
      render: (text, record) => {
        return <div>
          ...
          <br/>
          <a href="#" onClick={me.check.bind(me, '查看详情', record, true)}>查看详情</a>
        </div>
      }
    }];
    ...
    return (
        <div className="block-panel">
            ...
            <Table columns={columns} rowKey={this.rowKey}
             ...
             <Check ref="Check" key={state.CheckKeyModal} dataForm={state.dataForm} recordSoure={state.recordSoure} dataRecord={state.dataRec} visible={state.visible1} title={state.title} hideModal={me.hideModal} record={state.rowRecord}
