...
export default React.createClass({
    ...
    fetch() {
        ...
        for (var i = 0; i < item1.length - 1; i++) {
            ...
            data3.push(result.data.fifteenDaysNeedRepay[item2[i]]);
            data1.push(result.data.fifteenDaysRealRepay[item2[i]]);
            data2.push((parseFloat(result.data.fifteenDaysOverdueApr[item2[i]]) * 100).toFixed(2));
        }
        data3.push(result.data.fifteenDaysNeedRepay[item2[item1.length - 1]]);
        data1.push(result.data.fifteenDaysRealRepay[item2[item1.length - 1]]);
