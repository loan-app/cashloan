          ...
          <Row>
            <Col span="24">
              <FormItem {...formItemLayout} label="还款时间:">
                <DatePicker format="yyyy-MM-dd HH:mm:ss" showTime disabledDate={this.disabledStartDate} value={this.state.startValue} {...getFieldProps('repayTimes', { rules: [{ required: true, message: '必填', type: 'date' }], onChange: (value) => { this.setState({ startValue: value }) } }) } />
              </FormItem>
            </Col>
          </Row>
          {state.value == 3 ?
