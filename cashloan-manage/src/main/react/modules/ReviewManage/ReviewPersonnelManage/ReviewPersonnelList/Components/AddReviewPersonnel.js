...
var AddReviewPersonnel = React.createClass({
  getInitialState() {
    return {
      status: {},
      formData: {}
  ...
  handleOk(e) {
    ...
    var url = "/modules/manage/system/user/saveReview.htm";
...
AddReviewPersonnel = createForm()(AddReviewPersonnel);
export default AddReviewPersonnel;