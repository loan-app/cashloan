...
export default React.createClass({
  ...
  fetch(params = {}) {
    ...
    Utils.ajaxData({
      url: '/modules/manage/credit/sceneBusiness/page.htm',
      data: params,
      callback: (result) => {
  ...
  componentDidMount() {
    ...
    var InterfaceList = [];
    Utils.ajaxData({
      url: '/modules/manage/credit/tpp/listAll.htm',
      method: 'get',
      type: 'json',
      callback: (result) => {
  ...
  changeStaus(title, record) {
    ...
    var urlStr = title == "启用" ? "/modules/manage/credit/sceneBusiness/enable.htm" :　"/modules/manage/credit/sceneBusiness/disable.htm";
    Utils.ajaxData({
      url: urlStr,
      data: params,
      callback: (result) => {
