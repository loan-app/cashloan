...
var Lookdetails = React.createClass({
  ...
  fetch(params = {}) {
    ...
    this.setState({
      ...
      Utils.ajaxData({
      url: ' /modules/manage/credit/tppBusiness/page.htm',
      data: params,
      callback: (result) => {
  ...
  changeStatus(record,title) {
        var params = {
            ...
            var url = title == "启用"?"/modules/manage/credit/tppBusiness/enable.htm":"/modules/manage/credit/tppBusiness/disable.htm";
            Utils.getData({
                url: url,
                data: params,
                callback: (result) => {
