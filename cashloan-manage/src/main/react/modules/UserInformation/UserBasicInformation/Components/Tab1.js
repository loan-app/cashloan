          ...
          : null}
            <div className="navLine-wrap-left">
              ...
              <Row>
                <Col span="8">
                  <FormItem {...formItemLayout} label="其他联系人姓名：">
                    <Input {...getFieldProps('otherThirdName', { initialValue: '' }) } disabled={props.canEdit} />
                  </FormItem>
                </Col>
                <Col span="8">
                  <FormItem {...formItemLayout} label="其他联系人联系方式：">
                    <Input {...getFieldProps('otherThirdPhone', { initialValue: '' }) } disabled={props.canEdit} />
                  </FormItem>
                </Col>
                <Col span="8">
                  <FormItem {...formItemLayout} label="其他联系人与本人关系：">
                    <Input {...getFieldProps('otherThirdRelation', { initialValue: '' }) } disabled={props.canEdit} />
                  </FormItem>
                </Col>
              </Row>
              <h2>认证状态</h2>
            ...
            <Show ref='Show' title={state.tit} visible={state.visible} recordSoure={props.recordSoure} num={state.num} hidden={this.hidden} />
          </Form>
    );
  }
});
