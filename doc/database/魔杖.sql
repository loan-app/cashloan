...
CREATE TABLE `cl_magic_mobile_contact` (
	...
	`contact_type_30d` VARCHAR (100) DEFAULT NULL COMMENT '近30天直接联系人命中黑名单的类型, 格式：逾期,欺诈',
	...
	`contact_type_90d` VARCHAR (100) DEFAULT NULL COMMENT '近90天直接联系人命中黑名单的类型, 格式：逾期,欺诈',
	...
	`contact_type_180d` VARCHAR (100) DEFAULT NULL COMMENT '近180天直接联系人命中黑名单的类型, 格式：逾期,欺诈',
...
CREATE TABLE `cl_magic_intimate_contact` (
	...
	`intimate_type_30d` VARCHAR (100) DEFAULT NULL COMMENT '近30天亲密直接联系人命中黑名单的类型, 格式：逾期,欺诈',
	...
	`intimate_type_90d` VARCHAR (100) DEFAULT NULL COMMENT '近90天亲密直接联系人命中黑名单的类型, 格式：逾期,欺诈',
	...
	`intimate_type_180d` VARCHAR (100) DEFAULT NULL COMMENT '近180天亲密直接联系人命中黑名单的类型, 格式：逾期,欺诈',
